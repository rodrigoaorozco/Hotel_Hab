  ...
  return (
    <>
      <main className=' mt-12'>
            <Carousel></Carousel>
            <div className='w-5/6 md:w-3/4 m-auto bg-orange-200 mt-12 p-4 text-center'>
              <h2 className='font-semibold'>VEN Y DISFRUTA DE UNA ESTANCIA DE LO MAS GLAMUROSA</h2>
              ...
              <div className='m-auto w-full md:w-3/4 gap-8 flex md:flex-row flex-col items-center flex justify-center p-6'>
                <img src="/images/suite/suite11.jpg" className='w-2/4 md:w-1/4' alt="" />
                <img src="/images/premium/premium11.jpg" className='w-2/4 md:w-1/4' alt="" />
                <img src="/images/dormitorio/dormi11.jpg" className='w-2/4 md:w-1/4' alt="" />
              </div>
              ...
              <h2 className='font-semibold mt-10'>TODOS LOS SERVICIOS PARA TI</h2>
              <div className='m-auto w-full md:w-3/4 gap-8 flex md:flex-row flex-col items-center justify-center p-6'>
                <img src="/images/hotel/piscina.jpg" alt="" className='w-2/4 md:w-1/4' />
                <img src="/images/hotel/bar.jpg" alt="" className='w-2/4 md:w-1/4 ' />
                <img src="/images/hotel/terraza.jpg" alt="" className='w-2/4 md:w-1/4' />
                <img src="/images/hotel/jardin.jpg" alt="" className='w-2/4 md:w-1/4' />
              </div>
              ...
              <h2 className=' font-semibold mt-10'>RESTAURANTE BUFFET LIBRE</h2>
              <div className='m-auto w-full md:w-3/4 gap-8 flex md:flex-row flex-col items-center flex justify-center p-6'>
                <img src="/images/hotel/comedor1.jpg" alt="" className='w-2/4 md:w-1/4 ' />
                <img src="/images/hotel/comedor2.jpg" alt="" className='w-2/4 md:w-1/4 ' />
                <img src="/images/hotel/comedor3.jpg" alt="" className='w-2/4 md:w-1/4 ' />
              </div>
