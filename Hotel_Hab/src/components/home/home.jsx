    ...
    <>
      <main className=' mt-12'>
            ...
            <div className='w-3/4 m-auto bg-orange-200 mt-12 p-4 text-center'>
              ...
              <div className='m-auto w-3/4 flex justify-center p-6'>
                <img src="/images/hotel/piscina.jpg" alt="" className='w-60 mx-6 animation-' />
                <img src="/images/hotel/bar.jpg" alt="" className='w-60 mx-6' />
                <img src="/images/hotel/terraza.jpg" alt="" className='w-60 mx-6 animation-' />
                <img src="/images/hotel/jardin.jpg" alt="" className='w-60 mx-6 animation-' />
              </div>
