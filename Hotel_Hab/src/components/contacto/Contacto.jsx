...
function Contacto() {
    return (
        <>
            <div className='mt-6 m-auto w-full lg:w-2/3 text-center'>
                ...
                <div className=' w-4/5 bg-orange-200 m-auto mt-8 p-6 rounded'>
                    <div className='m-5 w-full flex flex-col items-center'>
                        <label>Nombre:</label>
                        <input type="text" placeholder='Nombre...' className='w-2/3 rounded p-1 m-auto' />
                    </div>
                    <div className='m-5 w-full flex flex-col items-center'>
                        <label>Apellido:</label>
                        <input type="text" placeholder='Apellido...' className='w-2/3 rounded p-1' />
                    </div>
                    <div className='m-5 w-full flex flex-col items-center'>
                        <label>Email:</label>
                        <input type="email" placeholder='Email...' className='w-2/3 rounded p-1' />
                    </div>
                    <div className='m-5 w-full flex flex-col items-center'>
                        <label>Consulta:</label>
                        <textarea type="textarea" placeholder='Escribe aquí tu consulta...' rows={5}  className='w-2/3 rounded p-1' />
                    </div>
